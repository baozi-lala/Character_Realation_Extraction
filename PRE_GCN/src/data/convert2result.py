...
parser.add_argument("--input_path", default='./results/docpre-dev/docred_basebert_full/test.errors')
parser.add_argument("--output_path", type=str,default='./results/docpre-dev/docred_basebert_full/result.json')
inp = parser.parse_args()
def fun():
    input_file = "../data/DocPRE/processed/test1_v2.json"
    ori_data=[]

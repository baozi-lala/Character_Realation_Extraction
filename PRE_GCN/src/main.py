...
def train(parameters):
    ...
    # else:
    if os.path.exists(os.path.join(model_folder, 'train_loader.pkl')):
        with open(os.path.join(model_folder, 'train_loader.pkl'), 'rb') as f:
            train_loader = pkl.load(f)
        with open(os.path.join(model_folder, 'train_data.pkl'), 'rb') as f:
            train_data = pkl.load(f)
        with open(os.path.join(model_folder, 'test_data.pkl'), 'rb') as f:
            test_data = pkl.load(f)
        with open(os.path.join(model_folder, 'prune_recall.pkl'), 'rb') as f:
    ...
    # print('Loading training data ...')
        ...
        with open(os.path.join(model_folder, 'train_loader.pkl'), 'wb') as f:
            pkl.dump(train_loader, f, pkl.HIGHEST_PROTOCOL)
        with open(os.path.join(model_folder, 'train_data.pkl'), 'wb') as f:
            pkl.dump(train_data, f, pkl.HIGHEST_PROTOCOL)
        with open(os.path.join(model_folder, 'test_data.pkl'), 'wb') as f:
            pkl.dump(test_data, f, pkl.HIGHEST_PROTOCOL)
        with open(os.path.join(model_folder, 'prune_recall.pkl'), 'wb') as f:

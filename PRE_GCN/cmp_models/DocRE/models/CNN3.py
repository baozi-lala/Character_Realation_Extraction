...
class CNN3(nn.Module):
    def __init__(self, config):
        ...
        self.bili = torch.nn.Bilinear(self.out_channels + config.dis_size, self.out_channels + config.dis_size,
                                      config.relation_num)
    ...
    def forward(self, context_idxs, pos, context_ner, context_char_idxs, context_lens, h_mapping, t_mapping,
        ...
        context_output = x.permute(0, 2, 1)  # batch * max_len * out_channels

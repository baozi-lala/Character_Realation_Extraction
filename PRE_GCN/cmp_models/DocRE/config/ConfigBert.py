...
class ConfigBert(object):
    ...
    def train(self, model_pattern, model_name):
        ...
        for epoch in range(self.max_epoch):
            ...
            for data in self.get_train_batch():
                ...
                predict_re = model(context_idxs, context_pos, context_ner, None, input_lengths, h_mapping, t_mapping, relation_mask, dis_h_2_t, dis_t_2_h, sent_idxs, sent_lengths, reverse_sent_idxs, context_masks, context_starts)
    ...
    def test(self, model, model_name, output_flag=False, input_theta=-1, two_phase=False, pretrain_model=None):
        data_idx = 0
        eval_start_time = time.time()
        # test_result_ignore = []
        ...
        for data in self.get_test_batch():
            with torch.no_grad():
                ...
                if two_phase:
                    is_rel_exist = pretrain_model(context_idxs, context_pos, context_ner, None, input_lengths,
                        ...
                        if h_idx != t_idx:
                            ...
                            for r in range(1, self.relation_num):
                                ...
                                if two_phase:
                                    ...
                                    test_result.append( ((h_idx, t_idx, r) in label, float(predict_re[i,j,r]), dist, intrain,  titles[i], self.id2rel[r], index, h_idx, t_idx, r) )

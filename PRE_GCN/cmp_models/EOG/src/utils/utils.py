...
#
#     folder_name = 'm{}-b{}-walks{}'.format(params['model'], params['batch'], length)
#
...
def setup_log(params, mode):
    ...
    folder_name = params['model']
    folder_name += '_' + str(params['feature']) + '_' + str(time.time())
    model_folder = params['folder'] + '/' + folder_name
